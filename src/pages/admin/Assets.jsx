...
export default function Assets() {
    ...
    async function handleSave() {
        if (!form.name || !form.asset_code) { 
            sileo.error({
                ...
                description: 'Asset Name and Asset Code are required fields.'
            }); 
            return; 
        }
        setSaving(true);
        if (editing) {
            ...
            sileo.success({
                title: 'Asset Created',
                description: `Successfully added ${form.name} to the system.`
            });
        }
        setSaving(false);
        setShowModal(false);
    ...
    async function handleDelete(id) {
        ...
        sileo.success({
            title: 'Asset Deleted',
            description: 'The asset has been permanently removed from the records.'
        });
        loadAssets();
    }
